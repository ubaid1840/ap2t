...
export function PaymentAlerts(){
  ...
  <CardHeader className="flex justify-between">
    ...
    <Badge className="bg-[#FF690033] text-[#FF8904] h-10 w-10 text-2xl">
      <Bell />
    </Badge>
  </CardHeader>
    ...
    <ScrollArea className="h-100"> 
      <div className="space-y-4 p-4">
        {alerts.map((alert, index) => (
          <Card
            key={index}
            className="bg-[#1A1A1A] border border-[#3A3A3A]"
          >
            <CardContent className="space-y-4">
              <div className="flex justify-between">
                ...
                <Badge className="bg-[#F0B10033] text-[#FDC700]">
                  ${alert.amount}
                </Badge>
              </div>
              <div className="flex gap-2">
                <Button className="bg-[#00C95033] text-[#05DF72] py-2 px-4">
                  Approve
                </Button>
                <Button className="bg-[#3A3A3A] text-[#D1D5DC] py-2 px-4">
                  Override
                </Button>
