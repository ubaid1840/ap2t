...
export default function Page() {
  return (
    <div className="flex flex-col gap-30">
        ...
        <div className="relative mt-40 flex flex-col items-center bg-[#090909]">
          ...
          <div className="z-10 space-y-8">
            <div className="flex flex-col w-full items-center gap-4 Web/letter-spacing/0">
              <h1 className="text-5xl ">Programs at Our Facility</h1>
      ...
      <section className="max-w-7xl mx-auto w-full lg:px-30  ">
      ...
      <section className="max-w-7xl w-full  ">
        ...
        <section className="max-w-7xl w-full lg:px-30 ">
